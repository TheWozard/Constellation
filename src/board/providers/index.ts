...
export const BoardContentProviders: BoardContentProvidersDescription[] = [
    {
        ...
        provider: new MemoryBoardContentProvider([
            { "details": { "name": "Starter", "description": "A board to help you getting started using Constellation", "last_updated": new Date("2022-03-23T01:00:00.506Z"), "columns": 9 }, "tiles": [{ "layout": { "x": 5, "y": 1, "w": 2, "h": 2, "static": false }, "style": {}, "data": { "type": "text", "data": { "text": "There are many things a board can do" } } }], "context": { "selected": [] } },
        ]),
    }
]